      ...
      <section className="bg-gradient-to-br from-blue-600 to-blue-800 text-white py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            ...
            <span className="text-orange-400"> Mentorship</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/partner/companies" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-blue-600 font-semibold py-3 px-6 rounded-lg transition-colors">
              Become a Partner
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-gray-600">Children Mentored</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Orphanages</h3>
              <p className="text-gray-600 mb-4">
                Register your orphanage to connect children with mentors from leading companies
                and access educational resources.
              </p>
              <Link href="/partner/orphanages" className="text-blue-600 font-semibold hover:text-blue-700">
                Register Now →
              </Link>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Companies</h3>
              <p className="text-gray-600 mb-4">
                Partner with us to provide mentorship, internships, and career guidance
                to young people from orphanages.
              </p>
              <Link href="/partner/companies" className="text-orange-600 font-semibold hover:text-orange-700">
                Partner With Us →
              </Link>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Education Institutes</h3>
              <p className="text-gray-600 mb-4">
                Collaborate with us to provide scholarships, training programs,
                and educational opportunities.
              </p>
              <Link href="/partner/education" className="text-green-600 font-semibold hover:text-green-700">
                Collaborate Now →
              </Link>
            </div>
          </div>
      ...
      <section className="py-20 px-4 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/newsletter" className="border-2 border-white text-white hover:bg-white hover:text-gray-900 font-semibold py-3 px-6 rounded-lg transition-colors">
