    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-emerald-800">Orphanages</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-amber-600">30+</div>
              <div className="text-emerald-800">Companies</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-teal-700">20+</div>
              <div className="text-emerald-800">Education Partners</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-emerald-600">500+</div>
              <div className="text-emerald-800">Children Impacted</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-emerald-900">Partner Orphanages</h2>
              <p className="text-emerald-800 mt-2">Orphanages we work with to connect children with opportunities</p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {orphanages.map((org, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-sm border hover:shadow-md transition-shadow">
                ...
                <h3 className="font-bold text-emerald-900 text-lg mb-2">{org.name}</h3>
                <p className="text-emerald-800 text-sm mb-1">{org.location}</p>
                <p className="text-emerald-700 text-sm font-medium">{org.children} children</p>
              </div>
            ))}

            {/* More Coming Card */}
            <div className="bg-stone-100 p-6 rounded-xl border-2 border-dashed border-gray-300 flex flex-col items-center justify-center text-center">
              <p className="text-gray-500 mb-2">And many more...</p>
              <Link href="/partner/orphanages" className="text-emerald-700 font-medium hover:text-emerald-600">
                Join our network →
              </Link>
            </div>
          </div>
      ...
      <section className="py-16 px-4 bg-stone-100">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-emerald-900">Corporate Partners</h2>
              <p className="text-emerald-800 mt-2">Companies providing mentorship and career opportunities</p>
            </div>
            <Link href="/partner/companies" className="bg-amber-600 hover:bg-amber-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors hidden md:inline-block">
              Become a Partner
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {companies.map((company, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-sm border hover:shadow-md transition-shadow">
                ...
                <h3 className="font-bold text-emerald-900 mb-2">{company.name}</h3>
                <p className="text-emerald-800 text-sm mb-1">{company.industry}</p>
                <p className="text-amber-700 text-sm font-medium">{company.mentors} mentors</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-emerald-900">Education Partners</h2>
              <p className="text-emerald-800 mt-2">Institutions providing scholarships and training programs</p>
            </div>
            <Link href="/partner/education" className="bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors hidden md:inline-block">
              Partner With Us
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {educationPartners.map((edu, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-sm border hover:shadow-md transition-shadow">
                ...
                <h3 className="font-bold text-emerald-900 mb-2">{edu.name}</h3>
                <p className="text-emerald-800 text-sm mb-1">{edu.type}</p>
                <p className="text-teal-700 text-sm font-medium">{edu.programs}</p>
              </div>
            ))}
            ...
            <div className="bg-stone-100 p-6 rounded-xl border-2 border-dashed border-gray-300 flex flex-col items-center justify-center text-center">
              ...
              <Link href="/partner/education" className="text-teal-700 font-medium hover:text-teal-600">
                Become a partner →
              </Link>
            </div>
          </div>
      ...
      <section className="py-20 px-4 bg-emerald-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/partner/companies" className="bg-amber-600 hover:bg-amber-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors">
              Corporate Partnership
            </Link>
            <Link href="/partner/education" className="bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors">
